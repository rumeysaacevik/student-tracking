...
2.6 dropCourse Object: It represents that a course chosen by the student has been dropped by 
the student again. 
...
2.10 instructors Object: Represents the listing of all instructors by the student so that 
information can be obtained  
2.11 registration Object: Represents student and teacher registration by admin. 
2.12 selectingCourse Object: Represent the student to view all courses and take the selected 
course  
